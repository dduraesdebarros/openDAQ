...
namespace RTGen.Types
{
    ...
    public class Argument : IArgument
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="Argument" /> class.</summary>
        public Argument(ITypeName type, string name, bool isConst = false, IArray arrayInfo = null, bool isEvalValue = false)
        {
            Type = type;
            Name = name;
            IsConst = isConst;
            ArrayInfo = arrayInfo;
            IsEvalValue = isEvalValue;
        }
        ...
        public Argument(ITypeName type, IArgument argument)
        {
            ...
            IsEvalValue = argument.IsEvalValue;
        }
        ...
        /// <summary>Argument could be represented by EvalValue.</summary>
        public bool IsEvalValue { get; set; }
